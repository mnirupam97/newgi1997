...
<table id="applicants">
 ...
 <c:forEach items="${userlist}" var="bsr">
    ...
    <td><a target="_self" href="${pageContext.request.contextPath}/download/pdf.do?fileName=${bsr.stu_aadhar_card}">Download Date Of Birth Document</a>
    <!-- 
       --><td><input type="button" onclick="viewdocs.do" value="Check Documents">
<%--     <td><a href="${pageContext.request.contextPath}/approve.do?student_username=${bsr.student_username}"
